...
const SettingsPage = ({ setSettingsToggle }) => {
  ...
  return (
    <motion.div
      ...
      animate={{ background: '#1f2937', opacity: 1 }}
      exit={{ opacity: 0 }}
      ...
      <motion.div
        ...
        <button
          ...
          className='px-8 py-2 mt-12 transition-all dark:bg-gray-800 dark:text-white text-gray-900 bg-white rounded-lg shadow-md w-fit active:scale-95'>
          Logout
        </button>
      </motion.div>
    </motion.div>
